                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <?php
                            $query = $conn->query("select * from profiles where page='lindi' and leader='1'");
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <?php
                                                $query = $conn->query("select * from profiles where page='lindi' and leader='2'");
                                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="box-body box-profile">
                                            <?php
                                            $query = $conn->query("select * from profiles where page='lindi' and leader='3'");
                                            while ($row = $query->fetch()) {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <?php
                                                $query = $conn->query("select * from profiles where page='lindi' and leader='4'");
                                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <?php
                                                $query = $conn->query("select * from profiles where page='lindi' and leader='5'");
                                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="box box-primary">
                                                <div class="box-body box-profile">
                                                    <?php
                                                    $query = $conn->query("select * from profiles where page='lindi' and leader='6'");
                                                    while ($row = $query->fetch()) {
