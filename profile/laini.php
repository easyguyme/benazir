    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="laini.php"><i class="fa  fa-sticky-note"></i> Laini</a></li>
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <?php
                            $query = $conn->query("select * from profiles where page='saba' and leader='1'");
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-body">
                                        <div class="col-sm-3">
                                            <?php
                                            $query = $conn->query("select * from ward where page='saba'");
                                            while ($row = $query->fetch()) {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <?php
                                                $query = $conn->query("select * from profiles where page='saba' and leader='2'");
                                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="box-body box-profile">
                                            <?php
                                            $query = $conn->query("select * from profiles where page='saba' and leader='3'");
                                            while ($row = $query->fetch()) {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <?php
                                                $query = $conn->query("select * from profiles where page='saba' and leader='4'");
                                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                <?php
                                                $query = $conn->query("select * from profiles where page='saba' and leader='5'");
                                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="box box-primary">
                                                <div class="box-body box-profile">
                                                    <?php
                                                    $query = $conn->query("select * from profiles where page='saba' and leader='6'");
                                                    while ($row = $query->fetch()) {
