            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><strong><a href="project/laini.php" class="uppercase">Projects</a></strong></span>
                            <span class="info-box-number" style="font-size: x-small;"><a href="project/laini.php" class="uppercase">Complete | Current </a></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-number" style="font-size: large"><strong><a href="event/laini.php" class="uppercase">Events & Activities</a></strong></span>
                            <span class="info-box-number" style="font-size: x-small;"><a href="event/laini.php" class="uppercase">Upcoming | Ongoing | Cancelled</a></span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number" style="font-size: large"><strong> <a href="plans/laini.php" class="uppercase">Plans & Budgets</a></strong></span>
                            <span class="info-box-number" style="font-size: x-small;"><a href="plans/laini.php" class="uppercase">Community priorities | County priorities</a></span>
                        </div>
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                $query = $conn->query("select * from profiles where page='saba'") or die(mysql_error());
                        ...
                        <div class="box-body no-padding">
                            <ul class="users-list clearfix">
                                ...
                                while ($row = $query->fetch()) {
                                    ...
                                    ?>
                                    <li>
                                        <img src="saba/<?php echo $row['image']; ?>" alt="User Image">
                                        <a class="users-list-name" href="profile/laini.php"><?php echo $row['named']; ?></a>
                    ...
                    <div class="box box-warning ">
                        ...
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                ...
                                $query = $conn->query("select * from profile_tbl where page='saba'") or die(mysql_error());
                                while ($row = $query->fetch()) {
                        ...
                        <!-- /.box-body -->
                        <div class="box-footer text-center">
                            <a href="profile/laini.php" class="uppercase">Read More</a>
                        </div>
                        <!-- /.box-footer-->
                    </div>
                    <!-- /.box -->
                ...
                <div class="col-md-4">
                    <div class="box box-success">
                        ...
                        <div class="box box-solid">
                            ...
                            $query = $conn->query("select * from lagallery") or die(mysql_error());
                            $count = $query->rowcount();
                            $slides='';
                            $Indicators='';
                            $counter=0;
