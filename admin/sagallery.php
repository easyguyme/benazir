                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="box box-solid">
                            ...
                            $query = $conn->query("select * from sagallery order by date desc") or die(mysql_error());
                            ...
                            <div class="row-fluid">
                                ...
                                <div id="block_bg" class="block">
                                    ...
                                    <div class="block-content collapse in">
                                        <div class="span12">
                                            <form action="sagallery.php" method="post">
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $query = $conn->query("select * from sagallery order by date desc");
                                                    while ($row = $query->fetch()) {
                                                        $id = $row['id'];
                                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30"><a href="editsagallery.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
