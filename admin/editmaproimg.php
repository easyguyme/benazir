                    ...
                    <div class="col-md-8">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Update Makina Gallery Images</h3>
...
if (isset($_POST['save'])){
    ...
    $conn->query("update maproimg set title='$title' , dsc ='$descp' , image='$location' where id = '$get_id' ")or die(mysql_error());
