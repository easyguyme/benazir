                    ...
                    <div class="box box-info">
                        ...
                        <form  method="post">
                            ...
                            <div class="box-body">
                                ...
                                $query = $conn->query("select * from dev_saba where id='$get_id'");
...
if (isset($_POST['save'])){
    ...
    $conn->query("update dev_saba set planned = '$planned',ongoing='$ongoing' where id = '$get_id' ")or die(mysql_error());


    ?>
    <script>
        window.location = "editlainidev.php<?php echo '?id='.$get_id; ?>";
    </script>
    <?php
