                    ...
                    <div class="col-md-6">
                        <div class="box box-solid">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title"><dt> View Makina Uploaded Images</dt></h3>
                            ...
                            $query = $conn->query("select * from maproimg order by date desc") or die(mysql_error());
                        ...
                        <div class="box box-info">
                            <div class="row-fluid">
                                ...
                                <div id="block_bg" class="block">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Edit Makina Uploaded Pics</h3>
                                    </div>
                                    <div class="block-content collapse in">
                                        <div class="span12">
                                            <form action="maproimg.php" method="post">
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                    ...
                                                    while ($row = $query->fetch()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30"><a href="editmaproimg.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['save'])){
    ...
    $conn->query("insert into maproimg (title,dsc,image) values('$title','$descp','$location')")or die(mysql_error());



    ?>
    <script>
        window.location = "maproimg.php";
    </script>
    <?php
