                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Community Priorities </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                            ...
                            $query = $conn->query("select * from prior_com  where id='$get_id'") or die(mysql_error());
...
if (isset($_POST['save'])){
    ...
    $conn->query("update prior_com set makina = '$makina',sara='$sara' ,laini='$laini',lindi='$lindi'  where id = '$get_id' ")or die(mysql_error());


    ?>
    <script>
        window.location = "editcomprior.php<?php echo '?id='.$get_id; ?>";
    </script>
    <?php
