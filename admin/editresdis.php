                    ...
                    <div class="col-md-8">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Update Resources Distribution Images</h3>
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    <?php
                                    $query = $conn->query("select * from resimg where page='$get_id'");
                                    while ($row = $query->fetch()) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="name" class="col-sm-2 control-label">Ward:</label>

                                            <div class="col-sm-4 ">
                                                <input type="text" name="page" class="form-control" id="desc" placeholder="Type of quote" value="<?php echo $row['page']; ?>"  disabled>
...
if (isset($_POST['save'])){
    ...
    $path = "../dist/img/". $_FILES["image"]["name"];

    $conn->query("update resimg  set img='$path' where page ='$get_id' ") or die(mysqli_error());
