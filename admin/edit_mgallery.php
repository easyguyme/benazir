                ...
                <div class="col-md-8">
                    <div class="box box-info">
                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <?php
                                $query = $conn->query("select * from mediaimg where id='$get_id'");
                                while ($row = $query->fetch()) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 input-sm">
                                            <input type="text" name="desc" class="form-control" id="desc" placeholder="Type of quote" value="<?php echo $row['descp']; ?>"  required>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
if (isset($_POST['save'])){
    ...
    $conn->query("update mediaimg set title='$title' , descp='$descp' , image='$location' where id = '$get_id' ")or die(mysql_error());



    ?>
    <script>
        window.location = "media_gallery.php";
    </script>
    <?php
