            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Sarang'ombe Development Projects  </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                            <div class="box-body">
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="input-group  col-sm-10">
                                        ...
                                        <input type="text" name="planned" class="form-control" id="area" placeholder="planned"  required>
                                    </div>
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="input-group  col-sm-10">
                                        ...
                                        <input type="text" name="ongoing" class="form-control" id="population" placeholder="ongoing"  required>
                                    </div>
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><dt>Sarang'ombe Development Projects </dt></h3>
                        ...
                        <div class="box-body table-responsive">
                            <form action="sardev.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                    ...
                                    while ($row = $query->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="30"><a href="editsardev.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['save'])){
    ...
    $conn->query("insert into dev_sara (planned,ongoing) values('$planned','$ongoing')")or die(mysql_error());

    ?>
    <script>
        window.location = "sardev.php";
    </script>
    <?php
...
if (isset($_POST['delete_macop'])){
    ...
    for($i=0; $i < $N; $i++)
    {
        $query = $conn->query("DELETE FROM dev_sara where id='$id[$i]'");
    }
