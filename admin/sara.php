                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"> <a  href="sara_project.php">click me</a></span>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"> <a href="sapb.php">click me</a></span>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="saprofile.php"  class="small-box-footer">click me <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="#pdsara" data-toggle="modal" data-target="#pdsara" class="small-box-footer">Click me <i class="fa fa-arrow-circle-right"></i></a>
...
<style>
    ...
    <div class="modal example-modal" id="pdsara" role="dialog">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Update Sarang'ombe Area Profile Table</h4>
                    </div>
                    <div class="modal-body">
                        <?php
                        $query = $conn->query("select * from profile_tbl where page='sara'");
...
if (isset($_POST['makdes'])) {
    ...
    $query="update profile_tbl set area = :area, population = :population , village = :village, fund =:fund , mca= :mca,admin=:admin where page ='sara' ";
