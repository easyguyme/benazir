                ...
                <div class="col-md-6">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">View Lindi Map</h3>
                ...
                <div class="col-md-6">
                    <div class="box box-danger">
                        ...
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">View Lindi Centre brief</h3>
                    ...
                    <div class="box box-success">
                        <div class="row-fluid">
                            ...
                            <div id="block_bg" class="block">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Edit Lindi centre details</h3>
                                </div>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                                                ...
                                                while ($row = $query->fetch()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30"><a href="editlicentre.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
