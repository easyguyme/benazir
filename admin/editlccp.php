                ...
                <div class="col-md-6">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Laini saba Complete County Project</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                            <?php
                            $query = $conn->query("select * from saba_cproject where id='$get_id'");
                    ...
                    <div class="box box-info">
                        <div class="row-fluid">
                            ...
                            <div id="block_bg" class="block">
                                <div class="box-header with-border">
                                    <h3 class="box-title">View Laini saba Complete County Projects</h3>
                                </div>
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form action="lccp.php" method="post">
                                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = $conn->query("select * from saba_cproject where org='county' ");
                                                while ($row = $query->fetch()) {
                                                    $id = $row['id'];
                                                    ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30"><a href="editlccp.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['update'])){
    ...
    $conn->query("update saba_cproject set name = '$name', sdate='$sdate' ,edate='$edate'  where id = '$get_id' ")or die(mysql_error());


    ?>
    <script>
        window.location = "lccp.php";
    </script>
    <?php
