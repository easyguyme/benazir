                    ...
                    <div class="col-md-8">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Update Laini saba Gallery Images</h3>
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    <?php
                                    $query = $conn->query("select * from lagallery where id='$get_id'");
...
if (isset($_POST['save'])){
    ...
    $conn->query("update lagallery set title='$title' , dsc ='$descp' , image='$location' where id = '$get_id' ")or die(mysql_error());
