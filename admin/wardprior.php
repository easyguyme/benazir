                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Ward/County Priorities  </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
...
if (isset($_POST['save'])){
    ...
    $conn->query("insert into prior_county (makina,sara,laini,lindi) values('$makina','$sara','$lindi','$laini')")or die(mysql_error());
