                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Community Priorities </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                            <div class="box-body">
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="input-group  col-sm-8">
                                        ...
                                        <input type="text" name="makina" class="form-control" id="area" placeholder="makina"  required>
                                    </div>
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="input-group  col-sm-8">
                                        ...
                                        <input type="text" name="sara" class="form-control" id="population" placeholder="sarangombe"  required>
                                    </div>
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="input-group  col-sm-8">
                                        ...
                                        <input type="text" name="lindi" class="form-control" id="village" placeholder="lindi"  required>
                                    </div>
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="input-group  col-sm-8">
                                        ...
                                        <input type="text" name="laini" class="form-control" id="fund" placeholder="laini"  required>
                                    </div>
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            <form action="comprior.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                    ...
                                    $query = $conn->query("select * from prior_com") or die(mysql_error());
                                    while ($row = $query->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="30"><a href="editcomprior.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
