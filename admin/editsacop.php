            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Sarang'ombe  County Government Priority</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><dt>Sarang'ombe County Government Priorities</dt></h3>
                        ...
                        <div class="box-body table-responsive">
                            <form action="sacop.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                    ...
                                    $query = $conn->query("select * from plans_county where page='sara'") or die(mysql_error());
                                    while ($row = $query->fetch()) {
                                        $id = $row['id'];
                                        ...
                                        <tr>
                                            ...
                                            <td width="30"><a href="editsacop.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
