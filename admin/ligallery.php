            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-solid">
                        ...
                        $query = $conn->query("select * from ligallery order by date desc") or die(mysql_error());
                        ...
                        <div class="row-fluid">
                            ...
                            <div id="block_bg" class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form action="ligallery.php" method="post">
                                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = $conn->query("select * from ligallery order by date desc");
                                                while ($row = $query->fetch()) {
                                                    $id = $row['id'];
                                                    ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30"><a href="editligallery.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['save'])){
    ...
    $conn->query("insert into ligallery (title,dsc,image) values('$title','$descp','$location')")or die(mysql_error());



    ?>
    <script>
        window.location = "ligallery.php";
    </script>
    <?php
...
if (isset($_POST['makina_pics'])){
    ...
    for($i=0; $i < $N; $i++)
    {
        $query = $conn->query("DELETE FROM ligallery where id='$id[$i]'");
    }
    ?>
    <script>
        window.location = "ligallery.php";
