                    ...
                    <div class="col-md-8">
                        <div class="box box-info">
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    <?php
                                    $query = $conn->query("select * from laproimg where id='$get_id'");
...
if (isset($_POST['save'])){
    ...
    $conn->query("update laproimg set title='$title' , dsc ='$descp' , image='$location' where id = '$get_id' ")or die(mysql_error());
