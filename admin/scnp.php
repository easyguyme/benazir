            ...
            <div class="col-md-6">
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Sarang'ombe Complete NGO Project</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form  method="post">
                ...
                <div class="box box-info">
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="box-header with-border">
                                <h3 class="box-title">View Sarang'ombe Complete NGO Projects</h3>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form action="scnp.php" method="post">
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                            ...
                                            while ($row = $query->fetch()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30"><a href="editscnp.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
