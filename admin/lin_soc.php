                        ...
                        <div class="row-fluid">
                            ...
                            <div id="block_bg" class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form action="lin_soc.php" method="post">
                                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = $conn->query("select * from social_audit where page='lindi' ");
                                                while ($row = $query->fetch()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30"><a href="editlinsoc.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
