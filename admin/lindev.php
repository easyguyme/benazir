            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Lindi Development Projects  </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><dt>Lindi Development Projects </dt></h3>
                        ...
                        <div class="box-body table-responsive">
                            <form action="lindev.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                    ...
                                    while ($row = $query->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="30"><a href="editlindev.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['save'])){
    ...
    $conn->query("insert into dev_lindi (planned,ongoing) values('$planned','$ongoing')")or die(mysql_error());

    ?>
    <script>
        window.location = "lindev.php";
    </script>
    <?php
...
if (isset($_POST['delete_macop'])){
    ...
    for($i=0; $i < $N; $i++)
    {
        $query = $conn->query("DELETE FROM dev_lindi where id='$id[$i]'");
    }
