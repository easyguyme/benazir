                    ...
                    <div class="box box-info">
                        ...
                        <form method="post" class="form-horizontal">
                            ...
                            if (isset($_POST['update'])){
                                ...
                                $conn->query("update hgallery set maintitle='$title' where id = '1' ")or die(mysql_error());
                        ...
                        <div class="row-fluid">
                            ...
                            <div id="block_bg" class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form action="delete_pics.php" method="post">
                                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                <a data-toggle="modal" href="#picsdelete" id="delete"  class="btn btn-sm btn-danger">Delete</a>
                                                ...
                                                <tbody>
                                                <?php
                                                $query = $conn->query("select * from hgallery order by date desc");
                                                while ($row = $query->fetch()) {
                                                    $id = $row['id'];
                                                    ?>
