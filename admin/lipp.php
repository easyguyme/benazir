            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Lindi Community Priority Project</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><dt>Lindi Communities Priorities Projects</dt></h3>
                        ...
                        <div class="box-body table-responsive">
                            <form action="lipp.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                    ...
                                    $query = $conn->query("select * from plan_comm where page='lindi'") or die(mysql_error());
                                    while ($row = $query->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="30"><a href="editlipp.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
