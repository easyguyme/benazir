            ...
            <div class="col-md-6">
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Sarang'ombe Current County Project</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form  method="post">
                        <?php
                        $query = $conn->query("select * from saracurrent where id='$get_id'");
                ...
                <div class="box box-info">
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="box-header with-border">
                                <h3 class="box-title">View Sarang'ombe Current County Projects</h3>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form action="saccp.php" method="post">
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                            ...
                                            while ($row = $query->fetch()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30"><a href="editsaccp.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['update'])){
    ...
    $conn->query("update saracurrent set name = '$name', des='$des' ,per='$per'  where id = '$get_id' ")or die(mysql_error());


    ?>
    <script>
        window.location = "editsaccp.php<?php echo '?id='.$get_id; ?>";
    </script>
    <?php
