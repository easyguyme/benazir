                    ...
                    <div class="col-md-6">
                        <div class="box box-solid">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title"><dt> View Lindi Uploaded Images</dt></h3>
                            ...
                            $query = $conn->query("select * from liproimg order by date desc") or die(mysql_error());
                    ...
                    <div class="col-md-6">
                        <div class="box box-info">
                            ...
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Update Lindi Gallery</h3>
                        ...
                        <div class="box box-info">
                            <div class="row-fluid">
                                ...
                                <div id="block_bg" class="block">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Edit Lindi Uploaded Pics</h3>
                                    </div>
                                    <div class="block-content collapse in">
                                        <div class="span12">
                                            <form action="liproimg.php" method="post">
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                    ...
                                                    <div id="makinadelete" class="modal  fade modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-header">
                                                            ...
                                                            <h3 id="myModalLabel">Delete Lindi image(s)?</h3>
                                                        </div>
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $query = $conn->query("select * from liproimg order by date desc");
                                                    while ($row = $query->fetch()) {
                                                        $id = $row['id'];
                                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30"><a href="editliproimg.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['save'])){
    ...
    move_uploaded_file($_FILES["image"]["tmp_name"], "../lindi/" . $_FILES["image"]["name"]);
    $location =  $_FILES["image"]["name"];



    $conn->query("insert into liproimg (title,dsc,image) values('$title','$descp','$location')")or die(mysql_error());



    ?>
    <script>
        window.location = "liproimg.php";
    </script>
    <?php
...
if (isset($_POST['makina_pics'])){
    ...
    for($i=0; $i < $N; $i++)
    {
        $query = $conn->query("DELETE FROM liproimg where id='$id[$i]'");
    }
    ?>
    <script>
        window.location = "liproimg.php";
