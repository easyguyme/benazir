            ...
            <div class="col-md-6">
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Sarang'ombe Current County Project</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form  method="post">
...
if (isset($_POST['save'])){
    ...
    $conn->query("insert into saracurrent (name,des,per,type) values('$name','$des','$per','$type')")or die(mysql_error());


    ?>
    <script>
        window.location = "saccp.php";
    </script>
    <?php
...
if (isset($_POST['delete_ccp'])){
    ...
    for($i=0; $i < $N; $i++)
    {
        $query = $conn->query("DELETE FROM  saracurrent where id='$id[$i]'");
    }
    ?>
    <script>
        window.location = "saccp.php";
