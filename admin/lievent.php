                ...
                <div class="col-md-6">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Lindi Events</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                    ...
                    <div class="box box-info">
                        <div class="row-fluid">
                            ...
                            <div id="block_bg" class="block">
                                <div class="box-header with-border">
                                    <h3 class="box-title">View Lindi Events</h3>
                                </div>
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form action="lievent.php" method="post">
                                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                                ...
                                                <tbody>
                                                <?php
                                                $query = $conn->query("select * from events where page='lindi'");
                                                while ($row = $query->fetch()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30"><a href="editlievent.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
