                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">EDIT SARANG'OMBE COMMUNITY PRIORITIES PROJECTS</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            <form action="sapp.php" method="post">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                    ...
                                    $query = $conn->query("select * from plan_comm where page='sara'") or die(mysql_error());
                                    while ($row = $query->fetch()) {
                                        $id = $row['id'];
                                        ...
                                        <tr>
                                            ...
                                            <td width="30"><a href="editsapp.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
