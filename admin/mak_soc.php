                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form action="mak_soc.php" method="post">
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="exampl2">
                                            <a data-toggle="modal" href="#socialdelete" id="delete"  class="btn btn-sm btn-danger">Delete</a>
                                            ...
                                            <tbody>
                                            <?php
                                            $query = $conn->query("select * from social_audit where page='makina' ");
                                            while ($row = $query->fetch()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30"><a href="editmaksoc.php<?php echo '?id='.$id; ?>" class="btn btn-sm btn-success">Edit</a></td>
...
if (isset($_POST['delete_social'])){
    ...
    for($i=0; $i < $N; $i++)
    {
        $query = $conn->query("DELETE FROM social_audit where id='$id[$i]'");
    }

    ?>
    <script>
        window.location = "mak_soc.php";
    </script>
    <?php
