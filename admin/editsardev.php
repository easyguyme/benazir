                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Sarang'ombe Development Projects </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form  method="post">
                            ...
                            <div class="box-body">
                                ...
                                $query = $conn->query("select * from dev_sara where id='$get_id'");
...
if (isset($_POST['save'])){
    ...
    $conn->query("update dev_sara set planned = '$planned',ongoing='$ongoing' where id = '$get_id' ")or die(mysql_error());


    ?>
    <script>
        window.location = "editsardev.php<?php echo '?id='.$get_id; ?>";
    </script>
    <?php
