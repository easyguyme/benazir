            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><strong><a href="project/lindi.php" class="uppercase">Projects</a></strong></span>
                            <span class="info-box-number" style="font-size: x-small;"><a href="project/lindi.php" class="uppercase">Complete | Current </a></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-number" style="font-size: large"><strong><a href="event/lindi.php" class="uppercase">Events & Activities</a></strong></span>
                            <span class="info-box-number" style="font-size: x-small;"><a href="event/lindi.php" class="uppercase">Upcoming | Ongoing | Cancelled</a></span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number" style="font-size: large"><strong> <a href="plans/lindi.php" class="uppercase">Plans & Budgets</a></strong></span>
                            <span class="info-box-number" style="font-size: x-small;"><a href="plans/lindi.php" class="uppercase">Community priorities | County priorities</a></span>
                        </div>
                    ...
                    <div class="box box-warning ">
                        ...
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                ...
                                $query = $conn->query("select * from profile_tbl where page='lindi'") or die(mysql_error());
                                while ($row = $query->fetch()) {
